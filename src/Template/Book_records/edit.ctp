<form id='edit-book' method="post" action="<?= $this->Url->build(['controller' => 'Book_records', 'action' => 'update', $book_record->title]) ?>">
...
<div class='input-div'>
  ...
  <textarea form='edit-book' id='description' type='text' name='description' maxlenght='250' rows='6'><?= h($book_record->description) ?></textarea>
